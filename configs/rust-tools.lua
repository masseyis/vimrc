...
local lldb_adaper = require('rust-tools.dap').get_codelldb_adapter(codelldb_path, liblldb_path)
lldb_adaper.name = "rust-codelldb"
local options = {
   dap = {
        adapter = lldb_adaper,
    },
...
local lldb = {
	name = "Attach to Rust",
	type = "rt_lldb", -- matches the adapter
	request = "attach", -- could also attach to a currently running process
